...
function onLoad(){
    ...
    if (params.get('userID') != null) {
        ...
        document.getElementById("homeNav").href = "../home_simple?userID=" + userID;
        document.getElementById("historyNav").href = "../history_simple?userID=" + userID;
    }
...
function addArticle (location, title, description, date, id, photo = 'default_news_photo.png') {
    document.getElementById(location).innerHTML +=
        ...
        `  <div class="card h-100" style="transition: transform 0.2s, background-color 0.2s; cursor: pointer; background-color: #f8f9fa; border: none;" onclick="window.open('../article_simple?articleID=${id}&userID=${userID}', '_blank')">\n` +
