...
def outputSQLQuery(form):
    ...
    cursor.execute("INSERT INTO MessageClassifications (ArticleID, UserID, MessageID, Message, Classification) VALUES (%s, %s, %s, %s, %s)",
                   (articleID, userID, messageID, message, classification))
    con.commit()
