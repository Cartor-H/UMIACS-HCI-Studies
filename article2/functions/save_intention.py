...
def outputSQLQuery(form):
    ...
    cursor.execute("INSERT INTO MessageIntentions (ArticleID, UserID, MessageID, Message, Intention) VALUES (%s, %s, %s, %s, %s)",
                   (articleID, userID, messageID, message, intention))
    con.commit()
